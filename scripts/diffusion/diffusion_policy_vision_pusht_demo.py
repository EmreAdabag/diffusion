...
with tqdm(range(num_epochs), desc='Epoch') as tglobal:
    ...
    for epoch_idx in tglobal:
        ...
        if (epoch_idx + 1) % 20 == 0:
            ...
            # Save checkpoint
            checkpoint_path = f"pusht_vision_{epoch_idx+1}ep.ckpt"
            torch.save(ema_nets.state_dict(), checkpoint_path)
...
final_checkpoint_path = f"pusht_vision_{num_epochs}ep.ckpt"
torch.save(ema_nets.state_dict(), final_checkpoint_path)
